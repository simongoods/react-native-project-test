      ...
      <View style={styles.container}>
        ...
        <View style={styles.first}>
          ...
          <Slider
            ...
            onSlidingComplete={(value1) => this.onSlidingComplete_total(value1)}
        ...
        <View style={styles.second}>
          ...
          <Slider
            {...this.props}
            step={0.1}
            onSlidingComplete={(value2) => this.onSlidingComplete_total(value2)}
        ...
        <View style={styles.third}>
          ...
          <Slider
            {...this.props}
            step={0.1}
            onSlidingComplete={(value3) => this.onSlidingComplete_total(value3)}
